...
/*   Updated: 2020/09/03 13:46:29 by vkurkela         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		draw_battle_info(t_vm *vm)
{
	...
	werase(win);
	wattron(win, COLOR_PAIR(M_B) | A_BOLD);
	mvwprintw(win, 2, 4, "%ls", B1);
	mvwprintw(win, 3, 4, "%ls", B2);
	mvwprintw(win, 4, 4, "%ls", B3);
	mvwprintw(win, 5, 4, "%ls", B4);
	mvwprintw(win, 6, 4, "%ls", B5);
	wattroff(win, COLOR_PAIR(M_B) | A_BOLD);
